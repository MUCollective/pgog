...
```{r}
ggplot(mtcars) +  geom_bloc(aes(y = c(mpg), height = c(P(mpg)))) 
ggplot(mtcars) +  geom_bloc(aes(y = c(mpg), height = c(P(mpg))),side = "up") 
ggplot(mtcars) +  geom_bloc(aes(y = c(mpg), height = c(P(mpg))),side = "down")
ggplot(mtcars) +  geom_bloc(aes(y = c(mpg), height = c(P(mpg))),side = "both") 
```
